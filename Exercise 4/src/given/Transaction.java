...
class Transaction
{
	...
	private ArrayList<Integer> probe_list;
	...
	{
		probe_list = new ArrayList<Integer>();
	...
	public void addToProbelist(ArrayList<Integer> probelist, int t_id){
		probe_list = probelist;

		probe_list.add(t_id);
	}
	public ArrayList<Integer> getProbelist(){
		return this.probe_list;
	}
	public int getTransactionId(){
		return transactionId;
	}
//	public given.Server probe(ArrayList<Integer> probelist, List<Resource> resources){
//	
//			//Transaction waitingOn = transactionsAtThisServer.get(resource.getLockOwner());
//			return newServer;
